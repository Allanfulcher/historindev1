    ...
    <div className={`grid gap-4 ${className}`}>
      {historias.map((historia) => (
        <button
          ...
          className="group relative flex items-start gap-4 rounded-xl bg-[#FEFCF8] p-4 shadow-sm ring-1 ring-[#A0958A]/20 transition-all duration-300 hover:shadow-lg hover:ring-1 hover:ring-[#8B4513]/20 text-left w-full cursor-pointer transform hover:scale-[1.02] active:scale-[0.98]"
        >
          <div className="relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-lg bg-[#F5F1EB]">
            <img
            ...
            />
            <div className="absolute inset-0 rounded-lg ring-1 ring-inset ring-[#A0958A]/10" />
          </div>
          
          <div className="flex-1 min-w-0">
            <h3 className="text-base font-medium text-[#4A3F35] line-clamp-2">
              {historia.titulo}
            </h3>
            <p className="mt-1 text-sm text-[#6B5B4F] line-clamp-2">
              {historia.descricao}
            </p>
          </div>
          
          <div className="absolute right-4 top-4 text-[#A0958A] group-hover:text-[#8B4513]">
