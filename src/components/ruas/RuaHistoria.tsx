      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <Link href="/" className="text-[#8B4513] hover:text-[#A0522D] hover:underline">
              Voltar ao início
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <main className="w-full">
        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex justify-between items-center mb-4">
                <button
                  ...
                  className="px-4 py-2 bg-[#F5F1EB] hover:bg-[#CD853F] hover:text-white rounded-md disabled:opacity-50 text-[#6B5B4F] transition-colors duration-200"
                >
                  ← Anterior
                </button>
              ...
              <h1 className="text-3xl font-bold mb-4 text-[#4A3F35]">{currentHistory.titulo}</h1>
              ...
              <div className="prose max-w-none">
                <p className="text-[#6B5B4F] leading-relaxed">{currentHistory.descricao}</p>
              </div>
              
              {currentHistory.ano && (
                <div className="mt-4 text-sm text-[#A0958A]">
          ...
          {activeTab === 'rua' && rua && (
            <div className="bg-[#FEFCF8] rounded-lg shadow-md p-6">
              <h1 className="text-3xl font-bold mb-4 text-[#4A3F35]">{rua.nome}</h1>
              ...
              <div className="prose max-w-none">
                <p className="text-[#6B5B4F] leading-relaxed">{rua.descricao}</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'cidade' && cidade && (
            <div className="bg-[#FEFCF8] rounded-lg shadow-md p-6">
              <h1 className="text-3xl font-bold mb-4 text-[#4A3F35]">{cidade.nome}</h1>
              {cidade.foto && (
                <img
                  src={cidade.foto}
                  alt={cidade.nome}
              ...
              <div className="prose max-w-none">
                <p className="text-[#6B5B4F] leading-relaxed">{cidade.descricao}</p>
              </div>
            </div>
          )}
        </div>
